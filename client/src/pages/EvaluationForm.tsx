    ...
    <div className="max-w-4xl mx-auto">
      ...
      <div id="form-container" className="bg-white p-6 rounded-lg">
        ...
        <div className="text-center mb-8 pb-6 border-b-2" style={{ borderColor: "#1a472a" }}>
          <img src="https://d2xsxph8kpxj0f.cloudfront.net/310519663511663974/bkxrxh5szwZfcvrDKi6FHK/GIOE_NewLogo_Green-dFGoVLnKfw5BAYmKfKRA62.webp" alt="GIOE Logo" className="h-24 mx-auto mb-4" />
