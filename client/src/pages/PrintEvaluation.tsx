    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-4xl mx-auto p-6">
        <div id="form-container" className="bg-white p-8 rounded-lg print:rounded-none print:p-0">
          ...
          {/* Suspeitos */}
          {(evaluation.mandadoDetencao || evaluation.mandadoBusca || evaluation.quantidadeSuspeitos !== "1") && (
            <div className="bg-gray-50 rounded-xl p-5 mb-5 border-l-4" style={{ borderColor: "#1a472a" }}>
              <div className="text-sm font-bold uppercase tracking-wider mb-4" style={{ color: "#1a472a" }}>
                Suspeitos
              </div>
              {evaluation.mandadoDetencao && <div className="text-sm mb-2">✓ Mandado de Detenção</div>}
              {evaluation.mandadoBusca && <div className="text-sm mb-2">✓ Mandado de Busca</div>}
              {evaluation.quantidadeSuspeitos && (
          ...
          {/* Atividade Criminal */}
          {(evaluation.modalidadeIsolado || evaluation.modalidadeAssociacao || evaluation.tipoCriminal || 
            evaluation.antecedentesContraPessoas || evaluation.antecedentesContraPatrimonio || 
            evaluation.antecedentesOutros || evaluation.antecedentesFSS) && (
            <div className="bg-gray-50 rounded-xl p-5 mb-5 border-l-4" style={{ borderColor: "#1a472a" }}>
              <div className="text-sm font-bold uppercase tracking-wider mb-4" style={{ color: "#1a472a" }}>
                Atividade Criminal
              </div>
              {evaluation.modalidadeIsolado && <div className="text-sm mb-2">✓ Modalidade: Isolado</div>}
              {evaluation.modalidadeAssociacao && <div className="text-sm mb-2">✓ Modalidade: Associação</div>}
              ...
              {evaluation.antecedentesContraPessoas && <div className="text-sm mb-2">✓ Antecedentes Contra Pessoas</div>}
              {evaluation.antecedentesContraPatrimonio && <div className="text-sm mb-2">✓ Antecedentes Contra Património</div>}
              {evaluation.antecedentesOutros && <div className="text-sm mb-2">✓ Outros Antecedentes</div>}
          ...
          {/* Meios */}
          {(evaluation.posseArma || evaluation.usoArma) && (
            <div className="bg-gray-50 rounded-xl p-5 mb-5 border-l-4" style={{ borderColor: "#1a472a" }}>
              <div className="text-sm font-bold uppercase tracking-wider mb-4" style={{ color: "#1a472a" }}>
                Meios
              </div>
          ...
          {/* Local */}
          {(evaluation.tipologiaApartamento || evaluation.tipologiaMoradia || evaluation.tipologiaOutro ||
            evaluation.contextoIsolado || evaluation.contextoBairroSocial || evaluation.contextoMeioUrbano || 
            evaluation.contextoMeioRural || evaluation.segurancaCaes || evaluation.segurancaPortaBlindada || 
            evaluation.segurancaOutrasMedidas) && (
            <div className="bg-gray-50 rounded-xl p-5 mb-5 border-l-4" style={{ borderColor: "#1a472a" }}>
              <div className="text-sm font-bold uppercase tracking-wider mb-4" style={{ color: "#1a472a" }}>
                Local
              </div>
              {evaluation.tipologiaApartamento && <div className="text-sm mb-2">✓ Tipologia: Apartamento</div>}
              {evaluation.tipologiaMoradia && <div className="text-sm mb-2">✓ Tipologia: Moradia</div>}
              {evaluation.tipologiaOutro && <div className="text-sm mb-2">✓ Tipologia: Outro</div>}
              {evaluation.contextoIsolado && <div className="text-sm mb-2">✓ Contexto: Isolado</div>}
              {evaluation.contextoBairroSocial && <div className="text-sm mb-2">✓ Contexto: Bairro Social</div>}
              {evaluation.contextoMeioUrbano && <div className="text-sm mb-2">✓ Contexto: Meio Urbano</div>}
              {evaluation.contextoMeioRural && <div className="text-sm mb-2">✓ Contexto: Meio Rural</div>}
              {evaluation.segurancaCaes && <div className="text-sm mb-2">✓ Segurança: Cães</div>}
              {evaluation.segurancaPortaBlindada && <div className="text-sm mb-2">✓ Segurança: Porta Blindada</div>}
              {evaluation.segurancaOutrasMedidas && <div className="text-sm mb-2">✓ Segurança: Outras Medidas</div>}
            </div>
          )}
