...
export default function PrintEvaluation() {
  ...
  const handleSaveNeop = () => {
    ...
    updateMutation.mutate({
      ...
      mandadoDetencao: evaluation.mandadoDetencao || 0,
      mandadoBusca: evaluation.mandadoBusca || 0,
      quantidadeSuspeitos: evaluation.quantidadeSuspeitos || "1",
      modalidadeIsolado: evaluation.modalidadeIsolado || 0,
      modalidadeAssociacao: evaluation.modalidadeAssociacao || 0,
      tipoCriminal: evaluation.tipoCriminal || "",
      antecedentesContraPessoas: evaluation.antecedentesContraPessoas || 0,
      antecedentesContraPatrimonio: evaluation.antecedentesContraPatrimonio || 0,
      antecedentesOutros: evaluation.antecedentesOutros || 0,
      antecedentesFSS: evaluation.antecedentesFSS || "",
      posseArma: evaluation.posseArma || "",
      usoArma: evaluation.usoArma || "",
      tipologiaApartamento: evaluation.tipologiaApartamento || 0,
      tipologiaMoradia: evaluation.tipologiaMoradia || 0,
      tipologiaOutro: evaluation.tipologiaOutro || 0,
      contextoIsolado: evaluation.contextoIsolado || 0,
      contextoBairroSocial: evaluation.contextoBairroSocial || 0,
      contextoMeioUrbano: evaluation.contextoMeioUrbano || 0,
      contextoMeioRural: evaluation.contextoMeioRural || 0,
      segurancaCaes: evaluation.segurancaCaes || 0,
      segurancaPortaBlindada: evaluation.segurancaPortaBlindada || 0,
      segurancaOutrasMedidas: evaluation.segurancaOutrasMedidas || 0,
